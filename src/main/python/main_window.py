...
from editor.combosPilot import CombosPilot
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, appctx):
        ...
        self.combos = Combos()
        self.new_combos = CombosPilot()  # 新增的实例
        ...
        self.editors = [(self.keymap_editor, "Keymap"), (self.layout_editor, "Layout"), (self.macro_recorder, "Macros"),
                        (self.rgb_configurator, "Lighting"), (self.tap_dance, "Tap Dance"), (self.combos, "Combos"), (self.new_combos, "CombosPilot"),
    ...
    def rebuild(self):
        ...
        for e in [self.layout_editor, self.keymap_editor, self.firmware_flasher, self.macro_recorder,
                  self.tap_dance, self.combos,self.new_combos, self.key_override, self.qmk_settings, self.matrix_tester,
